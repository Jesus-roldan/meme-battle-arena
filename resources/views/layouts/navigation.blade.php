<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex items-center gap-4">
                        <a href="{{ route('login') }}" class="text-gray-600 hover:text-blue-600 font-medium transition">Se connecter</a>
                        <a href="{{ route('register') }}" class="text-gray-600 hover:text-blue-600 font-medium transition">S’inscrire</a>
                    </div>
                @endif
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-4 border-t border-gray-200 flex flex-col items-center gap-3">
                <a href="{{ route('login') }}" class="text-gray-600 hover:text-blue-600 font-medium transition">Se connecter</a>
                <a href="{{ route('register') }}" class="text-gray-600 hover:text-blue-600 font-medium transition">S’inscrire</a>
            </div>
        @endif
